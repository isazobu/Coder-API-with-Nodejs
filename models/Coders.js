...
CodersSchema.pre("save", function (next) {
  this.slug = slugify(this.name, { lower: true });
  next();
});

// TODO BUG ----- Geocode & create location field
/*
CodersSchema.pre("save", async function (next) {
...
module.exports = mongoose.model("Coders", CodersSchema);
